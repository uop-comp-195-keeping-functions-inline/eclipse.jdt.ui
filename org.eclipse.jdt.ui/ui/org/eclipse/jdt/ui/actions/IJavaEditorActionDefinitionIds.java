...
public interface IJavaEditorActionDefinitionIds extends ITextEditorActionDefinitionIds {
	...
	/**
	 * Action definition ID of the navigate -> open popup javadoc action (value
	 * <code>"org.eclipse.jdt.ui.edit.text.java.open.external.javadoc.popup"</code>).
	 * 
	 * @since 3.18
	 */
	public static final String OPEN_POPUP_JAVADOC= "org.eclipse.jdt.ui.edit.text.java.open.external.javadoc.popup"; //$NON-NLS-1$
