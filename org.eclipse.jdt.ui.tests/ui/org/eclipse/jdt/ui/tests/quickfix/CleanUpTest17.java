...
public class CleanUpTest17 extends CleanUpTestCase {
	...
	private static final Class THIS= CleanUpTest17.class;
	...
	public void testRemoveRedundantTypeArguments1() throws Exception {
		...
		enable(CleanUpConstants.USE_TYPE_ARGUMENTS);
	...
	public void testInsertInferredTypeArguments1() throws Exception {
		IPackageFragment pack1= fSourceFolder.createPackageFragment("test1", false, null);
		StringBuffer buf= new StringBuffer();
		buf.append("package test1;\n");
		buf.append("import java.util.ArrayList;\n");
		...
		enable(CleanUpConstants.USE_TYPE_ARGUMENTS);
		enable(CleanUpConstants.INSERT_INFERRED_TYPE_ARGUMENTS);
